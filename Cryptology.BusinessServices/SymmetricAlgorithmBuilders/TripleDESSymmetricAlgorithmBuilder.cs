...
{
    public class TripleDESSymmetricAlgorithmBuilder : SymmetricAlgorithmBuilder
    {
        public TripleDESSymmetricAlgorithmBuilder() : base(SymmetricAlgorithmType.TripleDES)
        {
