...
{
    public class RijndaelManagedEncryption : SymmetricAlgorithmBuilder
    {
        #region Consts
        ...
        #endregion
        public RijndaelManagedEncryption() : base(SymmetricAlgorithmType.RijndaelManaged)
        {
        ...
        public override string Decrypt(string cipherText, string secretKey)
        {
            ...
            var aesAlg = NewRijndaelManaged(secretKey);
